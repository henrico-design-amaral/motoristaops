export const currentClosings = [
  ...
  {date:'2026-08-06',dateBR:'06/08/2026',day:'Qui',shift:'Parcial',platform:'Uber + Particular',hoursOnline:4.9167,hoursInRide:2.8333,kmTotal:57.6,kmPassenger:null,tripsUber:7,trips99:0,tripsPrivate:2,tripsTotal:9,revenueUber:98.94,revenue99:0,revenuePrivate:65,extras:0,grossRevenue:163.94,fuelCost:29.44,foodCost:0,washCost:0,operationalExpense:29.44,operationalProfit:134.50,notes:'Fechamento parcial. Combustível recalculado com padrão atual de etanol R$ 3,22/L e consumo informado de 6,3 km/L.'},
  {date:'2026-08-10',dateBR:'10/08/2026',day:'Seg',shift:'Misto',platform:'Uber + Particular',hoursOnline:10.1667,hoursInRide:8.1167,kmTotal:207.1,kmPassenger:150.54,tripsUber:14,trips99:0,tripsPrivate:2,tripsTotal:16,revenueUber:333.58,revenue99:0,revenuePrivate:65,extras:0,grossRevenue:398.58,fuelCost:74.93,foodCost:0,washCost:0,operationalExpense:74.93,operationalProfit:323.65,notes:'10h10 trabalhadas, 207,1 km, 14 viagens Uber + 2 particulares.'},
  {date:'2026-08-11',dateBR:'11/08/2026',day:'Ter',shift:'Misto',platform:'Uber + Particular',hoursOnline:7.7667,hoursInRide:6.9667,kmTotal:104.1,kmPassenger:71.28,tripsUber:17,trips99:0,tripsPrivate:2,tripsTotal:19,revenueUber:266.33,revenue99:0,revenuePrivate:65,extras:0,grossRevenue:331.33,fuelCost:48.56,foodCost:0,washCost:0,operationalExpense:48.56,operationalProfit:282.77,notes:'7h46 trabalhadas, 104,1 km, 17 viagens Uber + 2 particulares.'},
  {date:'2026-08-13',dateBR:'13/08/2026',day:'Qui',shift:'Misto',platform:'Uber + Particular',hoursOnline:10.25,hoursInRide:null,kmTotal:241,kmPassenger:null,tripsUber:20,trips99:0,tripsPrivate:2,tripsTotal:22,revenueUber:340.25,revenue99:0,revenuePrivate:65,extras:0,grossRevenue:405.25,fuelCost:84.35,foodCost:0,washCost:0,operationalExpense:84.35,operationalProfit:320.90,notes:'Fechamento consolidado anterior. Combustível estimado pelo padrão R$ 3,22/L e consumo 9,2 km/L.'},
  {date:'2026-08-16',dateBR:'16/08/2026',day:'Dom',shift:'Misto',platform:'Uber + Particular',hoursOnline:8.0,hoursInRide:null,kmTotal:222,kmPassenger:null,tripsUber:19,trips99:0,tripsPrivate:2,tripsTotal:21,revenueUber:332.36,revenue99:0,revenuePrivate:65,extras:0,grossRevenue:397.36,fuelCost:75.28,foodCost:0,washCost:0,operationalExpense:75.28,operationalProfit:322.08,notes:'Fechamento consolidado anterior. Combustível estimado pelo padrão R$ 3,22/L e consumo 9,5 km/L.'},
  {date:'2026-08-17',dateBR:'17/08/2026',day:'Seg',shift:'Misto',platform:'Uber + Particular',hoursOnline:14,hoursInRide:11.5167,kmTotal:254,kmPassenger:null,tripsUber:25,trips99:0,tripsPrivate:2,tripsTotal:27,revenueUber:437.41,revenue99:0,revenuePrivate:65,extras:0,grossRevenue:502.41,fuelCost:109.05,foodCost:0,washCost:0,operationalExpense:109.05,operationalProfit:393.36,notes:'14h trabalhadas; Uber R$ 437,41 em 25 viagens e 11h31 no app; transporte escolar particular ida e volta R$ 65,00; 254 km; consumo 7,5 km/L; combustível gerencial calculado a R$ 3,22/L. Abastecimento real registrado separadamente.'}
] as const;
...
export const currentFuelings = [
  ...
  {date:'2026-08-17',dateBR:'17/08/2026',fuel:'Etanol',liters:33.51,pricePerLiter:3.17,totalPaid:106.23,consumptionKmL:7.5,notes:'Abastecimento real. Indicadores gerenciais do fechamento usam preço-padrão de R$ 3,22/L.'}
] as const;
...
export const vehicleProfile = {
  vehicle:'Hyundai HB20 2019', fuel:'Etanol', referenceFuelPrice:3.22, recentOdometerKm:93550, privateRatePerKm:4.5
} as const;
