...
- regras GLOBAL/DOMAIN aplicáveis são herdadas pela MotoristaOPS;
- regras PROJECT/SURFACE MotoristaOPS permanecem específicas e não são copiadas cegamente para outros produtos;
- todo aprendizado portátil da MotoristaOPS deve subir para HenricoOPS;
